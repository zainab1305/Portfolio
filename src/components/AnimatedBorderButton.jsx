const AnimatedBorderButton = ({ children, href, download, ...props }) => {
  const baseClassName = `relative bg-transparent border border-border
  ...
  if (href) {
    return (
      <a href={href} download={download} className={baseClassName} {...props}>
        {content}
      </a>
    );
  }
